...
export default function App() {
  ...
  const continueGame = async (slot) => {
    ...
    try {
      ...
      setDetail(null);
      goToRoute('world', true);
      setSaveStatus((record.version ?? loadedUniverse.version ?? 7) < 9.4 ? 'Older save loaded — v0.9.4 adds continuity-first offseason logic, dynasty balance and player bookmarks.' : 'Save loaded');
    } catch (error) {
